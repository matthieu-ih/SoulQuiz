...
findQuizMateButton.addEventListener("click", function () {
  if (evilOutro.style.display === "flex") {
    evilOutro.style.display = "none";  
    U1name.style.display = "block";
    U1Evil.style.display = "block";
  }
});
...
letsGoButton.addEventListener("click", function () {
  ...
  } else if (evilQuestions1.style.display === "none") {
  ...
  if (
    (localStorage.user1Name &&
      localStorage.user2Name &&
      localStorage.user3Name) !== undefined
  ) {
  ...
  if (
    (localStorage.user1Name &&
      localStorage.user2Name &&
      localStorage.user3Name &&
      localStorage.user4Name) !== undefined
  ) {
  ...
  if (
    (localStorage.user1Name &&
      localStorage.user2Name &&
      localStorage.user3Name &&
      localStorage.user4Name &&
      localStorage.user5Name) !== undefined
  ) {
  ...
  if (
    (localStorage.user1Name &&
      ...
      localStorage.user3Name &&
      localStorage.user4Name &&
      localStorage.user5Name &&
      localStorage.user6Name) !== undefined
  ) {
  ...
  if (
    (localStorage.user1Name &&
      ...
      localStorage.user4Name &&
      localStorage.user5Name &&
      localStorage.user6Name &&
      localStorage.user7Name) !== undefined
  ) {
  ...
  if (
    (localStorage.user1Name &&
      ...
      localStorage.user5Name &&
      localStorage.user6Name &&
      localStorage.user7Name &&
      localStorage.user8Name) !== undefined
  ) {
  ...
  if (
    (localStorage.user1Name &&
      ...
      localStorage.user6Name &&
      localStorage.user7Name &&
      localStorage.user8Name &&
      localStorage.user9Name) !== undefined
  ) {
...
eframe1a[0].addEventListener("click", function () {
  ...
  if (localStorage.user2Name === undefined && user2 !== "") {
    ...
    console.log(user2);
  } else if (localStorage.user3Name === undefined && user3 !== "") {
  ...
  if (evilQuestions10.style.display === "block") {
    ...
    if (localStorage.user1Name === undefined) {
      ...
      localStorage.setItem(
        "user1evilQuizResult",
        JSON.stringify(user1.evilQuizResult)
      );
    } else if (localStorage.user2Name === undefined && user2 !== "") {
      ...
      localStorage.setItem(
        "user2evilQuizResult",
        JSON.stringify(user2.evilQuizResult)
      );
    } else if (localStorage.user3Name === undefined && user3 !== "") {
      ...
      localStorage.setItem(
        "user3evilQuizResult",
        JSON.stringify(user3.evilQuizResult)
      );
    } else if (localStorage.user4Name === undefined && user4 !== "") {
      ...
      localStorage.setItem(
        "user4evilQuizResult",
        JSON.stringify(user4.evilQuizResult)
      );
    } else if (localStorage.user5Name === undefined && user5 !== "") {
      ...
      localStorage.setItem(
        "user5evilQuizResult",
        JSON.stringify(user5.evilQuizResult)
      );
    } else if (localStorage.user6Name === undefined && user6 !== "") {
      ...
      localStorage.setItem(
        "user6evilQuizResult",
        JSON.stringify(user6.evilQuizResult)
      );
    } else if (localStorage.user7Name === undefined && user7 !== "") {
      ...
      localStorage.setItem(
        "user7evilQuizResult",
        JSON.stringify(user7.evilQuizResult)
      );
    } else if (localStorage.user8Name === undefined && user8 !== "") {
      ...
      localStorage.setItem(
        "user8evilQuizResult",
        JSON.stringify(user8.evilQuizResult)
      );
    } else if (localStorage.user9Name === undefined && user9 !== "") {
      ...
      localStorage.setItem(
        "user9evilQuizResult",
        JSON.stringify(user9.evilQuizResult)
      );
    } else if (localStorage.user10Name === undefined && user10 !== "") {
      ...
      localStorage.setItem(
        "user10evilQuizResult",
        JSON.stringify(user10.evilQuizResult)
      );
    }
  }
...
let U1name = document.getElementById("U1name");
let U1Evil = document.getElementById("U1Evil");
...
for (let i = 2; i < 11; i++) {
  U1Scores +=
    ...
    "Name} - ${user1User" +
    i +
    "EvilMatch}% SoulMatch <br>";
}

U1Evil.innerHTML = "`" + U1Scores + "`";


U1name.innerHTML = `SoulMatches:`

// U1Evil.innerHTML = `
// ${localStorage.user2Name} - ${user1User2EvilMatch}% SoulMatch <br>${localStorage.user3Name} - ${user1User3EvilMatch}% SoulMatch <br>${localStorage.user4Name} - ${user1User4EvilMatch}% SoulMatch <br>${localStorage.user5Name} - ${user1User5EvilMatch}% SoulMatch <br>${localStorage.user6Name} - ${user1User6EvilMatch}% SoulMatch <br>${localStorage.user7Name} - ${user1User7EvilMatch}% SoulMatch <br>${localStorage.user8Name} - ${user1User8EvilMatch}% SoulMatch <br>${localStorage.user9Name} - ${user1User9EvilMatch}% SoulMatch <br>${localStorage.user10Name} - ${user1User10EvilMatch}% SoulMatch <br>
// `;

U1Evil.innerHTML =
`${localStorage.user1Name} has a ${user1User2EvilMatch}% match with ${localStorage.user2Name}<br><br>
${localStorage.user1Name} has a  ${user1User3EvilMatch}% match with ${localStorage.user3Name}<br><br>
${localStorage.user1Name} has a  ${user1User4EvilMatch}% match with ${localStorage.user4Name}<br><br>
${localStorage.user1Name} has a  ${user1User5EvilMatch}% match with ${localStorage.user5Name}<br><br>
${localStorage.user1Name} has a  ${user1User6EvilMatch}% match with ${localStorage.user6Name}<br><br>
${localStorage.user1Name} has a  ${user1User7EvilMatch}% match with ${localStorage.user7Name}<br><br>
${localStorage.user1Name} has a  ${user1User8EvilMatch}% match with ${localStorage.user8Name}<br><br>
${localStorage.user1Name} has a  ${user1User9EvilMatch}% match with ${localStorage.user9Name}<br><br>
${localStorage.user1Name} has a  ${user1User10EvilMatch}% match with ${localStorage.user10Name}<br><br>
${localStorage.user2Name} has a  ${user2User3EvilMatch}% match with ${localStorage.user3Name}<br><br>
${localStorage.user2Name} has a  ${user2User4EvilMatch}% match with ${localStorage.user4Name}<br><br>
${localStorage.user2Name} has a  ${user2User5EvilMatch}% match with ${localStorage.user5Name}<br><br>
${localStorage.user2Name} has a  ${user2User6EvilMatch}% match with ${localStorage.user6Name}<br><br>
${localStorage.user2Name} has a  ${user2User7EvilMatch}% match with ${localStorage.user7Name}<br><br>
${localStorage.user2Name} has a  ${user2User8EvilMatch}% match with ${localStorage.user8Name}<br><br>
${localStorage.user2Name} has a  ${user2User9EvilMatch}% match with ${localStorage.user9Name}<br><br>
${localStorage.user2Name} has a  ${user2User10EvilMatch}% match with ${localStorage.user10Name}<br><br>
${localStorage.user3Name} has a  ${user3User4EvilMatch}% match with ${localStorage.user4Name}<br><br>
${localStorage.user3Name} has a  ${user3User5EvilMatch}% match with ${localStorage.user5Name}<br><br>
${localStorage.user3Name} has a  ${user3User6EvilMatch}% match with ${localStorage.user6Name}<br><br>
${localStorage.user3Name} has a  ${user3User7EvilMatch}% match with ${localStorage.user7Name}<br><br>
${localStorage.user3Name} has a  ${user3User8EvilMatch}% match with ${localStorage.user8Name}<br><br>
${localStorage.user3Name} has a  ${user3User9EvilMatch}% match with ${localStorage.user9Name}<br><br>
${localStorage.user3Name} has a  ${user3User10EvilMatch}% match with ${localStorage.user10Name}<br><br>
${localStorage.user4Name} has a  ${user4User5EvilMatch}% match with ${localStorage.user5Name}<br><br>
${localStorage.user4Name} has a  ${user4User6EvilMatch}% match with ${localStorage.user6Name}<br><br>
${localStorage.user4Name} has a  ${user4User7EvilMatch}% match with ${localStorage.user7Name}<br><br>
${localStorage.user4Name} has a  ${user4User8EvilMatch}% match with ${localStorage.user8Name}<br><br>
${localStorage.user4Name} has a  ${user4User9EvilMatch}% match with ${localStorage.user9Name}<br><br>
${localStorage.user4Name} has a  ${user4User10EvilMatch}% match with ${localStorage.user10Name}<br><br>
${localStorage.user5Name} has a  ${user5User6EvilMatch}% match with ${localStorage.user6Name}<br><br>
${localStorage.user5Name} has a  ${user5User7EvilMatch}% match with ${localStorage.user7Name}<br><br>
${localStorage.user5Name} has a  ${user5User8EvilMatch}% match with ${localStorage.user8Name}<br><br>
${localStorage.user5Name} has a  ${user5User9EvilMatch}% match with ${localStorage.user9Name}<br><br>
${localStorage.user5Name} has a  ${user5User10EvilMatch}% match with ${localStorage.user10Name}<br><br>
${localStorage.user6Name} has a  ${user6User7EvilMatch}% match with ${localStorage.user7Name}<br><br>
${localStorage.user6Name} has a  ${user6User8EvilMatch}% match with ${localStorage.user8Name}<br><br>
${localStorage.user6Name} has a  ${user6User9EvilMatch}% match with ${localStorage.user9Name}<br><br>
${localStorage.user6Name} has a  ${user6User10EvilMatch}% match with ${localStorage.user10Name}<br><br>
${localStorage.user7Name} has a  ${user7User8EvilMatch}% match with ${localStorage.user8Name}<br><br>
${localStorage.user7Name} has a  ${user7User9EvilMatch}% match with ${localStorage.user9Name}<br><br>
${localStorage.user7Name} has a  ${user7User10EvilMatch}% match with ${localStorage.user10Name}<br><br>
${localStorage.user8Name} has a  ${user8User9EvilMatch}% match with ${localStorage.user9Name}<br><br>
${localStorage.user8Name} has a  ${user8User10EvilMatch}% match with ${localStorage.user10Name}<br><br>
${localStorage.user9Name} has a  ${user9User10EvilMatch}% match with ${localStorage.user10Name}`
